...
public class JDialogAfficheGradErosion extends JDialog {
    ...
    public JDialogAfficheGradErosion(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = ContoursNonLineaire.gradientErosion(imageBare.getMatrice());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheGradErosion(new JFrame(), true,null,null).setVisible(true));
    }
}
