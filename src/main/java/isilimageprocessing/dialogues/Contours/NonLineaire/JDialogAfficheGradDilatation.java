...
public class JDialogAfficheGradDilatation extends JDialog {
    ...
    public JDialogAfficheGradDilatation(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = ContoursNonLineaire.gradientDilatation(imageBare.getMatrice());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheGradDilatation(new JFrame(), true,null,null).setVisible(true));
    }
}
