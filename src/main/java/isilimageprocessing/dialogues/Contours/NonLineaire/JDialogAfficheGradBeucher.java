...
public class JDialogAfficheGradBeucher extends JDialog {
    ...
    public JDialogAfficheGradBeucher(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = ContoursNonLineaire.gradientBeucher(imageBare.getMatrice());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheGradBeucher(new JFrame(), true,null,null).setVisible(true));
    }
}
