...
public class JDialogAfficheSeuilAuto extends JDialog {
    ...
    public JDialogAfficheSeuilAuto(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = Seuillage.seuillageAutomatique(imageBare.getMatrice());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheSeuilAuto(new JFrame(), true,null,null).setVisible(true));
    }
}
