...
public class JDialogAfficheFermeture extends JDialog {
    ...
    public JDialogAfficheFermeture(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = MorphoElementaire.fermeture(imageBare.getMatrice(), tailleMasque);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheFermeture(new JFrame(), true,null,null).setVisible(true));
    }
}
