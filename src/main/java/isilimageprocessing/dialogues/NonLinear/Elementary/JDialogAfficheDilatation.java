...
public class JDialogAfficheDilatation extends JDialog {
    ...
    public JDialogAfficheDilatation(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = MorphoElementaire.dilatation(imageBare.getMatrice(), tailleMasque);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheDilatation(new JFrame(), true,null,null).setVisible(true));
    }
}
