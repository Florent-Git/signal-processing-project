...
public class JDialogAfficheErosion extends JDialog {
    ...
    public JDialogAfficheErosion(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        ...
        int[][] imageTraitee = MorphoElementaire.erosion(imageBare.getMatrice(), tailleMasque);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogAfficheErosion(new JFrame(), true,null,null).setVisible(true));
    }
}
