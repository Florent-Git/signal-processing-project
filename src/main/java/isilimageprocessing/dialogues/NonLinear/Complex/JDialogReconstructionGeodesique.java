...
public class JDialogReconstructionGeodesique extends JDialog {
    ...
    public JDialogReconstructionGeodesique(Frame parent, boolean modal, int[][] matrice, String titre) {
        //super(parent, modal);
        setTitle(titre);
    ...
    private void displayImage() throws CImageNGException {
        int[][] imageTraitee = MorphoComplexe.reconstructionGeodesique(imageBare.getMatrice(), geodesicMask.getMatrice());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new JDialogReconstructionGeodesique(new JFrame(), true,null,null).setVisible(true));
    }
}
